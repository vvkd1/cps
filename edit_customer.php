...
if(isset($_REQUEST['cust_id']) && !empty($_REQUEST['cust_id'])){
	$row = $db->get_row("Select * from tb_customer where cust_id=".$_REQUEST['cust_id']."");	
}
?>
...
<?php require_once('header.php');	?>
                <div id="formdiv">
					<div id="formheading">Edit Customer</div>
					<div id="formfields">
						<form name="addcustomer" id="addcustomer" action="post_customer.php?do=edit&cust_id=<?php echo $_REQUEST['cust_id'] ?>" method="post">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txtcustname" id="txtcustname" value="<?php echo $row->cust_name ?>" style="width:183px">										
												</td>
											</tr>
											...
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txtcustshortname" id="txtcustshortname" value="<?php echo $row->cust_short_name ?>" style="width:183px" >										
												</td>
											</tr>
											...
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txtaccno" id="txtaccno" value="<?php echo $row->cust_acc_no ?>" style="width:183px">										
												</td>
											</tr>
											...
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txtadd" id="txtadd" value="<?php echo $row->cust_address ?>" style="width:183px">										
												</td>
											</tr>
