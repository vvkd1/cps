...
$row = $db->get_row("select * from tb_accountholdermaster where ach_Id = 0");
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td align="center" valign="top" style="border:1px solid; border-color:#cccccc;">
			<form id="accountmaster" name="accountmaster" method="post" action="post_accountholder.php" >
				  ...
				  <tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						...
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="ach_Authorized_Signatory1" id="ach_Authorized_Signatory1" value="<?php echo stripslashes($row->ach_Joint_Name2); ?>" style="width:190px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" />
							</label>
						</td>
					  </tr>
					  ...
					  <tr>
						...
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="ach_Authorized_Signatory2" id="ach_Authorized_Signatory2" value="<?php echo stripslashes($row->ach_Joint_Name2); ?>" style="width:190px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" />
							</label>
						</td>
					  </tr>
					  ...
					  <tr>
						...
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="ach_Authorized_Signatory3" id="ach_Authorized_Signatory3" value="<?php echo stripslashes($row->ach_Joint_Name2); ?>" style="width:190px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" />
							</label>
						</td>
					  </tr>
			  ...
			  <tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="txtAdd1" id="txtAdd1"  style="width:300px;" value="<?php echo stripslashes($row->branch_address1); ?>" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>(35 characters)</label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="txtAdd2" id="txtAdd2"  style="width:300px;" value="<?php echo stripslashes($row->branch_address2); ?>" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>(35 characters)</label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<select name="ddlcountry" id="ddlcountry" style="width:198px; height:26px;" onchange="showStates(this.value)">
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							...
							<div id="divstatelist">
								<select name="ddlstate" id="ddlstate" style="width:198px; height:26px;" onchange="showCity(this.value)">
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							...
							<div id="divcitylist">
								<select name="ddlcity" id="ddlcity" style="width:198px; height:26px;" onchange="showSuburb(this.value)" >
					...
					<td width="78%" align="left" valign="top">
						<label>
							...
							<div id="divsuburblist">
								<select name="ddlsuburb" id="ddlsuburb" style="width:198px; height:26px;" onchange="showpostalcode(this.value)">
