...
$row_edittransaction = $db->get_row("SELECT * FROM tb_cps_transactioncodes WHERE transactioncode_id=".$_REQUEST['tid']."");	
...
<?php require_once('header.php');	?>
                <div id="formdiv">
					<div id="formheading">Edit Transaction Code</div>
					<div id="formfields">
						<form name="addcountry" id="addcountry" action="post_transaction.php?do=edit&tid=<?php echo $_REQUEST['tid'] ?>" method="post">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txttransactioncodedescription" id="txttransactioncodedescription" value="<?php echo $row_edittransaction->transactioncodedescription; ?>" onKeyUp="javascript:this.value=this.value.toUpperCase();">										
												</td>
											</tr>
											...
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txttransactioncode" id="txttransactioncode" value="<?php echo $row_edittransaction->transactioncode; ?>" onKeyUp="javascript:this.value=this.value.toUpperCase();">										
												</td>
											</tr>
