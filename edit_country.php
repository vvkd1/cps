...
$row = $db->get_row("Select * from tb_countrymaster where country_id=".$_REQUEST['cid']."");	
...
<?php require_once('header.php');	?>
                <div id="formdiv">
					<div id="formheading">Edit Country</div>
					<div id="formfields">
						<form name="addcountry" id="addcountry" action="post_country.php?do=edit&cid=<?php echo $_REQUEST['cid'] ?>" method="post">
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txtcountryname" onKeyPress = "return isNumberKey1(event);" id="txtcountryname" value="<?php echo $row->country_name; ?>" onKeyUp="javascript:this.value=this.value.toUpperCase();">										
												</td>
											</tr>
											...
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txtcountrycode" id="txtcountrycode" value="<?php echo $row->country_code; ?>" onKeyUp="javascript:this.value=this.value.toUpperCase();">										
												</td>
											</tr>
