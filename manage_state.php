...
if(isset($_REQUEST['searchterm']) && !empty($_REQUEST['searchterm']) ) {
	$sql = "select state_id, state_name,state_code,is_delete from tb_statemaster where state_name like '%".GetSQLValueString($_REQUEST['searchterm'],"text")."%' ";
	$sql .= " order by state_name";
} else {
	$sql = "select state_id, state_name,state_code,is_delete from tb_statemaster";
	$sql .= " order by state_name";
}
												...
												<td width="100%" height="60px" align="left" valign="middle">
													<form id="frmsearch" name="frmsearch" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
														<div class="searchdiv">
															...
															<div style="float:left">
																<a href="manage_state.php"><img src="images/refresh.png" alt="Refresh"></a>
															</div>
															<div style="float:right">	
																<?php if(authentication_groups_pemissions($page_name,"","Y","Y","")):?>															
																	<a href="add_state.php" class="formtitlehead" style="text-decoration:underline">Add New State/Provience</a>&nbsp;															
																<?php endif;?>	
															</div>															
														</div>														
													</form>														
											...
											<tr>
												<td width="100%" colspan="10">
													...
													<div id="dialog-remove" title="Remove Confirmation" style="display:none;">
														<p style="float:left;"><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>This will deactivate the State.<br/>Are you sure?</p>
													</div>
