<?php
//this class only for next n previous button for flickbox
...
class Paginator{
	...
	function paginate()
	{
		...
		if($this->num_pages > 1)
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 1) ? "<div class=\"previous_active\"><a  href=\"$_SERVER[PHP_SELF]?page=$prev_page&ipp=$this->items_per_page$this->querystring\">&lt;&lt; View More</a></div> ":"<div class=\"viewmore_left\"><a href=\"#\" >&lt;&lt; View More</a></div> ";
			...
			$this->return .= (($this->current_page != $this->num_pages and $this->items_total >= 1) and ($_GET['page'] != 'All')) ? "<div class=\"viewmore\"><a href=\"$_SERVER[PHP_SELF]?page=$next_page&ipp=$this->items_per_page$this->querystring\">View More &gt;&gt;</a></div>":"<div class=\"viewmore_inactive\"><a href=\"#\" >View More &gt;&gt;</a></div>";
